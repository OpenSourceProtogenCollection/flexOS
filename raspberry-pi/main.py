...
#    visorMouth.write(b"1")
    print("attn")
    os.system("omxplayer -o local /home/pi/rapidchirp.wav > /dev/null")

def writeChg():
    visorEyes.write(b"2") # priority 4, left index
#    visorMouth.write(b"2")
    print("chg")
    os.system("omxplayer -o local /home/pi/powerrestored.wav > /dev/null")

def writeLow():
    visorEyes.write(b"g") # priority 5, left middle
#    visorMouth.write(b"g")
    print("low")
    os.system("omxplayer -o local /home/pi/lowbattery.wav > /dev/null")

def writeLost():
    visorEyes.write(b"f") # priority 5, left ring
#    visorMouth.write(b"f")
    print("lost")
    os.system("omxplayer -o local /home/pi/criticalalarm.wav > /dev/null")

def writeDni():
    visorEyes.write(b"4") # priority 5, left small
#    visorMouth.write(b"4")
    print("dni")
    os.system("omxplayer -o local /home/pi/dni.wav > /dev/null")
...
#    visorMouth.write(b"8")
    ...
    if randomNumber == 0:
        os.system("omxplayer -o local /home/pi/analysis.wav > /dev/null")
    else if randomNumber == 1:
        os.system("omxplayer -o local /home/pi/registered.wav > /dev/null")
    else if randomNumber == 2:
        os.system("omxplayer -o local /home/pi/vocalizing.wav > /dev/null")
    else if randomNumber == 3:
        os.system("omxplayer -o local /home/pi/analysis.wav > /dev/null")
    else if randomNumber == 4:
        os.system("omxplayer -o local /home/pi/idlynoisy.wav > /dev/null")
    else if randomNumber == 5:
        os.system("omxplayer -o local /home/pi/calculating.wav > /dev/null")

def writeCheck():
    visorEyes.write(b"6") # priority 4, right index
#    visorMouth.write(b"6")
    print("check")
    os.system("omxplayer -o local /home/pi/correct.wav > /dev/null")

def writeWrong():
    visorEyes.write(b"7") # priority 4, right middle
#    visorMouth.write(b"7")
    print("wrong")
    os.system("omxplayer -o local /home/pi/incorrect.wav > /dev/null")
...
#    visorMouth.write(b"0")
    ...
    if randomNumber == 0:
        os.system("omxplayer -o local /home/pi/identify.wav > /dev/null")
    else if randomNumber == 1:
        os.system("omxplayer -o local /home/pi/displayid.wav > /dev/null")
...
#    visorMouth.write(b"k")
    print("hungry")
    os.system("omxplayer -o local /home/pi/lifelost.wav > /dev/null")

def writeError():
    visorEyes.write(b"5") # priority 3, right beltline
#    visorMouth.write(b"5")
    print("error")
    os.system("omxplayer -o local /home/pi/criticalwarning.wav > /dev/null")

def writeLaugh():
    visorEyes.write(b"b") # priority 3, left hip
#    visorMouth.write(b"b")
    print("laugh")
    os.system("omxplayer -o local /home/pi/laughing.wav > /dev/null")

def writeSleep():
    visorEyes.write(b"d") # priority 3, right hip
#    visorMouth.write(b"d")
    print("sleep")
    os.system("omxplayer -o local /home/pi/snoring.wav > /dev/null")

def writeOwo():
    visorEyes.write(b"h") # priority 3, right collar
#    visorMouth.write(b"h")
    print("owo")
    os.system("omxplayer -o local /home/pi/owo.wav > /dev/null")

def writeHeart():
    visorEyes.write(b"j") # priority 2
#    visorMouth.write(b"j")
    print("heart")
    os.system("omxplayer -o local /home/pi/exclamation.wav > /dev/null")

def writeCoffee():
    visorEyes.write(b"3") # priority 1
#    visorMouth.write(b"3")
    print("coffee")
    os.system("omxplayer -o local /home/pi/coffee.wav > /dev/null")

def writeUwu():
    visorEyes.write(b"i") # priority 1
#    visorMouth.write(b"i")
    print("uwu")
    os.system("omxplayer -o local /home/pi/uwu.wav > /dev/null")

def writePhone():
    visorEyes.write(b"c") # priority 1
#    visorMouth.write(b"c")
    print("phone")
    os.system("omxplayer -o local /home/pi/phone.wav > /dev/null")

def writeCry():
    visorEyes.write(b"9")
#    visorMouth.write(b"9")
    print("cry")
    os.system("omxplayer -o local /home/pi/frazzled.wav > /dev/null")
